...
/* Generated By:JavaCC: Do not edit this line. CircuitParser.java */
  ...
  final public void GarbledCircuit() throws ParseException, CircuitDescriptionException, FileNotFoundException, IOException {OperationNameResolver.initOperations();
    Version_Line();
    label_1:
    while (true) {
...
try{
  ...
  final public void Version_Line() throws ParseException {int major = 1;
  int minor = 0;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VERSION:{
...
lineNumber++;
  ...
  final public void InputLine() throws ParseException, CircuitDescriptionException {String id;
  int bitcount;
  int party;
...
if( party != Input_Variable.CLIENT && party != Input_Variable.SERVER ){
  ...
  final public void OutputLine() throws ParseException {String outid;
...
context.addOutput(outid, isSigned );
  ...
  final public void PartyChange() throws ParseException, CircuitDescriptionException {int party;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case START_PARTY:{
...
if( included && partyComp != Input_Variable.ALL )
  ...
  final public void Include() throws ParseException, CircuitDescriptionException, FileNotFoundException, IOException {Token tpath;
...
String path = tpath.image;
  ...
  final public void EvalTerm() throws ParseException, CircuitDescriptionException {String outid;
  String name;
  Variable temp;
...
OpDirections op = OperationNameResolver.get( name );
  ...
  final public Variable VariableInput() throws ParseException, CircuitDescriptionException {String id;
  BigInteger num;
  Variable var;
  int bits;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return t.image;}
  ...
  final public BigInteger Digits() throws ParseException {Token t;
    t = jj_consume_token(INTEGER);
try{
      {if ("" != null) return new BigInteger( t.image );}
    } catch (NumberFormatException e){
      // will never happen
      {if ("" != null) return BigInteger.ZERO;}
    }
    throw new Error("Missing return statement in function");
  }

  final public int IntDigits() throws ParseException {Token t;
    t = jj_consume_token(INTEGER);
try{
  ...
  final public Map<String,String> Mapping() throws ParseException {String to;
  String from;
...
{if ("" != null) return ans;}
  ...
  final public Map<String,Variable> InMapping() throws ParseException, CircuitDescriptionException {String to;
  Variable from;
